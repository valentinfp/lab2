...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
module  add32_altbarrel_shift_t8e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //add32_altbarrel_shift_t8e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altbarrel_shift_3cg
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //add32_altbarrel_shift_3cg
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //add32_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
...
endmodule //add32_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	add32_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	add32_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //add32_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //add32_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	add32_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	add32_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //add32_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	add32_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	add32_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //add32_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	add32_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	add32_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //add32_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
	...
	add32_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	add32_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //add32_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	add32_altpriority_encoder_uv8   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	add32_altpriority_encoder_ue9   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //add32_altpriority_encoder_ou8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //add32_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	add32_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	add32_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
endmodule //add32_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
...
endmodule //add32_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_ii9
	( 
	data,
	q,
	zero) ;
	...
	add32_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
...
endmodule //add32_altpriority_encoder_ii9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //add32_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	add32_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	add32_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //add32_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	add32_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	add32_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //add32_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_i39
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	add32_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //add32_altpriority_encoder_i39

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altpriority_encoder_cna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	add32_altpriority_encoder_ii9   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	add32_altpriority_encoder_i39   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //add32_altpriority_encoder_cna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 716 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add32_altfp_add_sub_puj
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	add32_altbarrel_shift_t8e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	add32_altbarrel_shift_3cg   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	add32_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	add32_altpriority_encoder_cna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //add32_altfp_add_sub_puj
//VALID FILE
...
module add32 (
	...
	add32_altfp_add_sub_puj	add32_altfp_add_sub_puj_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
